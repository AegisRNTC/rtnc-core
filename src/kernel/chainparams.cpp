// Copyrigassert(consensus.hashGenesisBlockht (c) 2010 Satoshi Nakamotogenesis
...
{
    const char* pszTimestamp = "RTNC genesis 2026-02-07: Transparency by default";
    const CScript genesisOutputScript = CScript() << "02990c738dca7d06a0f981aaf237c514ec1ca78d077b10d0ab391efa817998c6f5"_hex << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock ==
               uint256{"000037594f66cb0c586131ff7bf25c029a8cd18943e67d5edbce74dbea110b81"});
        ...
        vSeeds.emplace_back("seed.rtnc.invalid."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.rtnc.invalid."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("seed.rtnc.invalid."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.rtnc.invalid."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.rtnc.invalid."); // Sjors Provoost
        vSeeds.emplace_back("seed.rtnc.invalid."); // Stephan Oeste
        ...
        chainTxData = ChainTxData{
            // Placeholder until RTNC has chain tx stats
            .nTime    = 0,
            .tx_count = 0,
            .dTxRate  = 0,
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("seed.test.rtnc.invalid.");
        vSeeds.emplace_back("seed.test.rtnc.invalid.");
        vSeeds.emplace_back("seed.test.rtnc.invalid.");
        ...
        chainTxData = ChainTxData{
            // Placeholder until RTNC testnet has chain tx stats
            .nTime    = 0,
            .tx_count = 0,
            .dTxRate  = 0,
        };
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vFixedSeeds.clear();
            vSeeds.emplace_back("seed.signet.rtnc.invalid.");
            vSeeds.emplace_back("seed.signet.rtnc.invalid."); // Ava Chow, only supports x1, x5, x9, x49, x809, x849, xd, x400, x404, x408, x448, xc08, xc48, x40c
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1707320000, 5, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256{"4ded3e7c7bba73c836de56d27a3518174be9561b02574d6b11beaa76c1e42ff8"});
        //assert(genesis.hashMerkleRoot == uint256{"05cf663b0c1acdb4635c1ef1f19c8ed63624d4c927101e7f597f34e2ee7e80f7"});
